<div class="aside">
    ...
    <ul class="nav">
      ...
      <?php $post_arr=array('posts','post-add','categories'); ?>
      <li <?php echo in_array($current_page, $post_arr)?'class="active"':''; ?>>
        <a href="#menu-posts" data-toggle="collapse" <?php echo in_array($current_page, $post_arr)?'':'class="collapsed"'; ?>>
          <i class="fa fa-thumb-tack"></i>文章<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-posts" <?php echo in_array($current_page, $post_arr)?'class="in collapse"':'class="collapse"'; ?>>
      ...
      <?php $setting_arr=array('nav-menus','slides','settings'); ?>
      <li <?php echo in_array($current_page, $setting_arr)?'class="active"':''; ?>>
        <a href="#menu-settings" data-toggle="collapse" <?php echo in_array($current_page, $setting_arr)?'':'class="collapsed"'; ?>>
          <i class="fa fa-cogs"></i>设置<i class="fa fa-angle-right"></i>
        </a>
        <ul id="menu-settings" <?php echo in_array($current_page, $setting_arr)?'class="in collapse"':'class="collapse"'; ?>>
